...
- **Templates API** — Resend-compatible template endpoints: `POST /templates`, `GET /templates`, `GET /templates/:id`, `PATCH /templates/:id` (and `PUT`), `DELETE /templates/:id`, `POST /templates/:id/publish`
...
[0.5.0]: https://github.com/jupitercl/resendev/releases/tag/v0.5.0
